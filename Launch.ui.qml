...
Rectangle {
    ...
    Image {
        ...
        source: Qt.resolvedUrl("assets/intersect_5.png")
    }
    Text {
        id: title
    ...
    Text {
        ...
        font.weight: Font.Normal
        horizontalAlignment: Text.AlignHCenter
        text: "Try another angle or velocity, you were x meters away!
 Watchout for the wind speed {insert wind direction and speed} "
        textFormat: Text.PlainText
        verticalAlignment: Text.AlignVCenter
