...
Rectangle {
    id: launch
    // Let the controller provide level-specific encouragement without changing the layout.
    property string bodyText: "Have a go at the next level!\n\nWatchout for the new wind speed!"
    ...
    Image {
        ...
        source: Qt.resolvedUrl("assets/Results/win.png")
    ...
    Text {
        ...
        font.weight: Font.Normal
        horizontalAlignment: Text.AlignHCenter
        // Bind the win message so the same component can celebrate different shots.
