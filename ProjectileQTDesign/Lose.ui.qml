...
Rectangle {
    id: launch
    // Let the controller provide level-specific guidance without changing the layout.
    property string bodyText: "Try another angle or velocity, you were x meters away!\n\nWatchout for the wind speed."
    ...
    Image {
        ...
        source: Qt.resolvedUrl("assets/Results/lose.png")
    }
    Text {
        id: title
        ...
        text: "You failed to hit the target!"
    ...
    Text {
        ...
        font.weight: Font.Normal
        horizontalAlignment: Text.AlignHCenter
        // Bind the lose message so each failed attempt can explain what to try next.
        text: launch.bodyText
        textFormat: Text.PlainText
        verticalAlignment: Text.AlignVCenter
